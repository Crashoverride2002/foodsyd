...
<div class="col50">
	<fieldset>
	<legend><?php echo vmText::_('COM_VIRTUEMART_MANUFACTURER_PRICE_DETAILS'); ?></legend>
	<table class="admintable">

		<?php //echo VmHTML::row('input','COM_VIRTUEMART_MANUFACTURER_NAME','mf_name',$this->manufacturer->mf_name,'class="required"'); ?>
		<?php echo VmHTML::row('raw','COM_VIRTUEMART_MANUFACTURER_PRICE_DATE',VmHtml::input('mf_name',$this->manufacturer->mf_name,'class="required inputbox"').$this->origLang); ?>
		...
		<?php echo VmHTML::row('select','COM_VIRTUEMART_MANUFACTURER_CATEGORY_NAME','virtuemart_manufacturercategories_id',$this->manufacturerCategories,$this->manufacturer->virtuemart_manufacturercategories_id,'style="width:200px;"','virtuemart_manufacturercategories_id', 'mf_category_name',false); ?>
