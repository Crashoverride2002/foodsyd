 ...
 * @copyright Copyright (c) 2020 - 2032 Kent Hanen
 * @version $Id: product_manufactor_edit_price.php 9821 2018-04-16 18:04:39Z Milbo $
	...
	<tr class="row<?php echo $rowColor?>">
		<td width="120px">
			<div style="text-align: right; font-weight: bold;">
				<span 
						class="hasTip"
						title ="<?php echo vmText::_('COM_VIRTUEMART_MANUFACTURER_PRICE_POWDER_TIP'); ?>">
						<?php
						$powder_production = array(0 => vmText::_ ('COM_VIRTUEMART_MANUFACTURER_PRICE_POWDER_NO'), 1 => vmText::_ ('COM_VIRTUEMART_MANUFACTURER_PRICE_POWDER_YES'));
						echo VmHtml::radioList ('mprices[override][' . $this->priceCounter . ']', $this->manufactor_price->allPrices[$this->manufactor_price->selectedPrice]['override'], $powder_production,'',' ');
						?>
				</span>
			</div>
		</td>
